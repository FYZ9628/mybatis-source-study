...
import com.ncf.mybatis.datasource.unpooled.UnpooledDataSource;
            ...
            synchronized (state) {
                ...
                if (conn != null) {
                    if (conn.isValid()) {
                        ...
                        logger.info("A bad connection (" + conn.getRealHashCode() + ") was returned from the pool, getting annother connection.");
                        // 如果没拿到，统计信息：失败链接 +1
                        state.badConnectionCount++;
